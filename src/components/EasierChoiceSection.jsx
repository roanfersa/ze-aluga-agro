  ...
  return (
    <div id="easier-choice" className="container my-5">
      <div className="d-flex align-items-center mb-2">
        <h2 className="font-family-primary me-2">Saiba o que outros agricultores estão usando</h2>
        <span className="badge bg-custom-secondary text-custom-primary">Feito para você</span>
      </div>

      <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 g-3">
        {cards.map(card => (
          <div key={card.id} className="col">
            <div className={`card text-white ${card.gradient} p-3 shadow-sm h-100`}>
